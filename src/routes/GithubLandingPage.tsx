    ...
    <div className='fixed top-0 left-0 w-screen h-screen flex items-center'>
      <div role="status w-fit mx-auto">
        ...
        }
        {
          ...
          <div className='w-auto p-10 text-center rounded-lg bg-red-50 text-black'>
            <div className='w-full text-center'>{errorMsg}</div>
            <div className='w-full text-center'>Go back to login page! <Link to='/login'>Login</Link></div>
          </div>
        }
      </div>
    </div>
