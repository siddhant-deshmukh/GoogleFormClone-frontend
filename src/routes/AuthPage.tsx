...
const LoginComponent = ({ authTypeToggle }: { authTypeToggle: 'login' | 'register' }) => {
  ...
  const login = useGoogleLogin({
    ...
    flow: 'auth-code',
    redirect_uri: `${import.meta.env.BASE_URL}?redirect=google`
  });
        ...
        {authTypeToggle === 'register' &&
          <form className="bg-white">
            ...
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
              ...
              <input disabled value={formState.name} onChange={handleFormChange} className="pl-2 outline-none border-none" type={'email'} name="name" placeholder="Email Address" />
            </div>
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
              ...
              <input disabled value={formState.password} onChange={handleFormChange} className="pl-2 outline-none border-none" type={'password'} name="password" id="" placeholder="Password" />
            </div>
            <button disabled type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Register</button>
        ...
        {authTypeToggle === 'login' &&
          <form className="bg-white">
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
              ...
              <input disabled value={formState.email} onChange={handleFormChange} className="pl-2 outline-none border-none" type="text" name="email" id="" placeholder="Full name" />
            </div>
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
                fill="currentColor">
            ...
            <button disabled type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
            {/* <span className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Forgot Password ?</span> */}
            <div className='text-xs font-mono'>
              Don't have account!
              <Link
