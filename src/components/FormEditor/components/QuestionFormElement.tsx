  ...
  ({ queKey, question, editQuestion, isSelected, setSelectedKey, deleteQuestion,addQuestion,saveQuestion}
    ...
    return (
      ...
      >
        ...
        {/* ------------------------------ first row to type Title and select ans type  --------------------------------------*/}
        {isSelected && <div className='flex flex-col space-y-3 w-full '>
          <>
        ...
        <div className='w-full flex flex-col space-y-2'>
          {
            ...
            <MultipleChoice queKey={queKey} question={question} editQuestion={editQuestion} isSelected={isSelected}/>
          }
          {
            ...
            <div className='my-3 mb-10 w-full px-4'>
              <input
                disabled
                onFocus={(event) => { event.target.select() }}
                className='text-xs bg-white  w-full border-b-2  border-b-gray-200  outline-none focus:outline-none focus:ease-in focus:duration-300 focus:border-purple-900 py-1 '
                defaultValue={(question.ans_type === 'short_ans') ? '  Short Answer' : '  Long Answer'} />
            </div>
          }
        </div>
        {/* ----------------                    footer  --------------------------------------------------------------- */}
        {isSelected && <div className='px-4 mt-4'>
